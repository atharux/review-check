...
export default function App() {
  ...
  return (
    <div className="wrap">
      ...
      <details className="hood" style={{ marginTop: 28 }}>
        ...
        <div className="hood-body">
          <p className="hood-note">
            ...
            keyword matching is the honest baseline this starts from:
          </p>
          ...
          <p className="hood-note" style={{ marginTop: 16 }}>
            ...
            blockers always float to the top; unconfirmed ones stay visible, just lower.
          </p>
        </div>
      </details>
      ...
      <div className="cta">
        <p>
          This ships with 6 illustrative rules, written fresh for this demo — not the real rule
          set. The paid audit runs against 27+ rules built from real client rejections, each
      ...
      <footer>
        <p>
          ...
          official Apple tool, and not a guarantee of App Store approval.
        </p>
      </footer>
    </div>
  );
