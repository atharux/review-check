...
export const RULES: Rule[] = [
  ...
  },
  {
    ...
    fix: "Test a clean install on the latest public OS release right before submitting, not an upgraded dev device.",
    severity: "blocker",
    appliesTo: ["launch"],
  },
  {
    ...
    looksFor: "A privacy policy URL that resolves publicly, with no login wall, and is about this app.",
  ...
  },
  {
    ...
    fix: "Add native functionality, or ship it as a web app instead of an App Store submission.",
    severity: "likely",
    appliesTo: ["main"],
    gatedBy: "webWrapped",
  },
  {
    ...
    fix: "Digital goods and unlocks go through StoreKit. External payment links are only allowed for a narrow, explicitly listed set of categories, so check the current exceptions before assuming yours qualifies.",
    severity: "blocker",
...
// The keyword table the classifier runs, shown in "Under the
